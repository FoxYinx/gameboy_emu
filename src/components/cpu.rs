...
impl CPU {
    ...
    pub(crate) fn process_opcode(&mut self, opcode: u8, memory: &mut Memory) -> (bool, u64) {
        ...
        match opcode {
            ...
            0x98 => {
                self.sbc_a_r8(self.registers.b);
                (false, 4)
            }
            0x99 => {
                self.sbc_a_r8(self.registers.c);
                (false, 4)
            }
            0x9A => {
                self.sbc_a_r8(self.registers.d);
                (false, 4)
            }
            0x9B => {
                self.sbc_a_r8(self.registers.e);
                (false, 4)
            }
            0x9C => {
                self.sbc_a_r8(self.registers.h);
                (false, 4)
            }
            0x9D => {
                self.sbc_a_r8(self.registers.l);
                (false, 4)
            }
            0x9E => {
                if let Some(value) = memory.get(self.registers.get_hl() as usize) {
            ...
            0x9F => {
                self.sbc_a_r8(self.registers.a);
                (false, 4)
            }
            0xA0 => {
            ...
            0xA8 => {
                self.xor_a_r8(self.registers.b);
                (false, 4)
            }
            0xA9 => {
                self.xor_a_r8(self.registers.c);
                (false, 4)
            }
            0xAA => {
                self.xor_a_r8(self.registers.d);
                (false, 4)
            }
            0xAB => {
                self.xor_a_r8(self.registers.e);
                (false, 4)
            }
            0xAC => {
                self.xor_a_r8(self.registers.h);
                (false, 4)
            }
            0xAD => {
                self.xor_a_r8(self.registers.l);
                (false, 4)
            }
            0xAE => {
                if let Some(value) = memory.get(self.registers.get_hl() as usize) {
            ...
            0xAF => {
                self.xor_a_r8(self.registers.a);
                (false, 4)
            }
            0xB0 => {
            ...
            0xB8 => {
                self.cp_a_r8(self.registers.b);
                (false, 4)
            }
            0xB9 => {
                self.cp_a_r8(self.registers.c);
                (false, 4)
            }
            0xBA => {
                self.cp_a_r8(self.registers.d);
                (false, 4)
            }
            0xBB => {
                self.cp_a_r8(self.registers.e);
                (false, 4)
            }
            0xBC => {
                self.cp_a_r8(self.registers.h);
                (false, 4)
            }
            0xBD => {
                self.cp_a_r8(self.registers.l);
                (false, 4)
            }
            0xBE => {
                if let Some(value) = memory.get(self.registers.get_hl() as usize) {
    ...
    fn cp_a_r8(&mut self, value: u8) {
        let a = self.registers.a;
        self.registers.set_z(a == value);
        self.registers.set_n(true);
    ...
    fn rst(&mut self, dest: u8, memory: &mut Memory) {
